from ..base import PeeWeeStrEnumBase
...
# CasteCommunity = PeeWeeStrEnumBase(
#     "CasteCommunity",
#     {k: v for k, v in zip(sorted(_AGG), sorted(_AGG))},
# )

CasteCommunity = PeeWeeStrEnumBase.create_enum("CasteCommunity", _AGG)